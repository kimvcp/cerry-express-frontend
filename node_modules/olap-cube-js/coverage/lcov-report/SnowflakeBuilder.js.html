...
<html lang="en">
<head>
    <title>Code coverage report for SnowflakeBuilder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> SnowflakeBuilder.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1381x</span>
<span class="cline-any cline-yes">1381x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2443x</span>
<span class="cline-any cline-yes">2443x</span>
<span class="cline-any cline-yes">1925x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2443x</span>
...
&nbsp;
	static processDimension(dimensionTree, cells, cellTable, factTable, factPrimaryKey) {
		...
		const { dimension, keyProps = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> otherProps = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> members: memberList, foreignKey, primaryKey } = dimensionTable;
...
&nbsp;
		function deleteProps(fact, props, factPrimaryKey) {
			props.forEach(prop =&gt; {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (prop !== factPrimaryKey) {
					delete fact[prop];
				}
			});
		}
...
&nbsp;
	...
	static makeMemberList(
		...
		entitiesPart,
		dimension,
		keyProps = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span>
		otherProps = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span>
		cells,
		cellTable,
...
&nbsp;
		...
		existedCells.forEach(cell =&gt; {
			...
			<span class="missing-if-branch" title="else path not taken" >E</span>if (!(surrogateKey in restoredCache)) {
...
&nbsp;
	static travers(cellTable, dimensionTree, handlers = <span class="fstat-no" title="function not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >()</span> =&gt; {})</span> {
