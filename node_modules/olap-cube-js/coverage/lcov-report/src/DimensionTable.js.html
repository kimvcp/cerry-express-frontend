...
<html lang="en">
<head>
    <title>Code coverage report for src/DimensionTable.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> DimensionTable.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1632x</span>
<span class="cline-any cline-yes">3103x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1632x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7694x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2439x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Member from './Member.js'
...
export default class DimensionTable {
	constructor({ dimension, foreignKey = DimensionTable.genericId(dimension), primaryKey = DEFAULT_MEMBER_ID_PROP, keyProps, otherProps = [], members = [], defaultMemberOptions = {}}) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(defaultMemberOptions).indexOf(primaryKey) !== -1) {
<span class="cstat-no" title="statement not covered" >			throw Error('Bad definition DimensionTable, \"defaultMemberOptions\" must not contain a \"primaryKey\" property');</span>
		}
	 ...
	 * */
	addMember(member) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.members.indexOf(member) === -1) {
			this.members.push(member)
		} else {
<span class="cstat-no" title="statement not covered" >			console.log('boo')</span>
		}
	}
	/**
	 * @public
	 ...
	 * @param {[]} linkProps
	 * */
	createMember(memberOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> linkProps) {
	...
	static reduceId(members, primaryKey) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (members.length) {
			return members.reduce((acc, curValue) =&gt; {
				return acc[primaryKey] &gt; curValue[primaryKey] ? <span class="branch-0 cbranch-no" title="branch not covered" >acc </span>: curValue;
			}, 0)[primaryKey] + 1
		} else {
...
<span class="fstat-no" title="function not covered" >	se</span>tMemberId(member, id) {
<span class="cstat-no" title="statement not covered" >		member[this.primaryKey] = id;</span>
	}
...
<span class="cstat-no" title="statement not covered" >			throw new Error('represented member was not found', member);</span>
		}
