...
<html lang="en">
<head>
    <title>Code coverage report for src/Cube.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Cube.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.48% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>266/294</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.88% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>99/134</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>259/287</span>
      </div>
    </div>
  </div>
...
721
722
723</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">711x</span>
<span class="cline-any cline-yes">2326x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">11018x</span>
<span class="cline-any cline-yes">11018x</span>
<span class="cline-any cline-yes">4930x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4934x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import EmptyCell from './EmptyCell.js'
...
&nbsp;
class CellTable {
	constructor({ cells, primaryKey, defaultFactOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>}) {
		this.cells = cells.map(cellData =&gt; {
			if (cellData instanceof Cell) {
				return cellData
			} else {
				return EmptyCell.isEmptyCell(cellData) ? <span class="branch-0 cbranch-no" title="branch not covered" >new EmptyCell(cellData) </span>: new Cell(cellData)
			}
		});
...
class Cube {
	constructor(cube) {
		let { dimensionHierarchies = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> cellTable = {} } = cube;
...
&nbsp;
		this.dimensionHierarchies = dimensionHierarchies.map(dimensionHierarchy =&gt; {
			...
			if (dimensionHierarchy.hierarchy) {
				<span class="missing-if-branch" title="if path not taken" >I</span>if (dimensionHierarchy instanceof DimensionHierarchy) {
<span class="cstat-no" title="statement not covered" >					return dimensionHierarchy;</span>
				} else {
					return DimensionHierarchy.createDimensionHierarchy(dimensionHierarchy);
				}
			} else <span class="missing-if-branch" title="else path not taken" >E</span>if (dimensionHierarchy.dimensionTable) {
...
<span class="cstat-no" title="statement not covered" >				if (dimensionHierarchy instanceof DimensionTable) {</span>
<span class="cstat-no" title="statement not covered" >					return dimensionHierarchy;</span>
				} else {
<span class="cstat-no" title="statement not covered" >					return DimensionTable.createDimensionTable(dimensionHierarchy);</span>
				}
			}
		});
	 ...
	 * @return {Cube}
	 * */
	static create(factTable, dimensionHierarchies = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> {
		...
		const { facts = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> primaryKey, defaultFactOptions = {} } = factTable;
...
&nbsp;
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (!dimensionTree) {
<span class="cstat-no" title="statement not covered" >				console.warn(`Not existed dimension: ${dimension}`);</span>
<span class="cstat-no" title="statement not covered" >				return;</span>
			...
			fixSpace[dimension].forEach((memberData, index) =&gt; {
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (!memberData) {
<span class="cstat-no" title="statement not covered" >					console.warn(`Not found member by id ${dimensionTable.getMemberId(member)}`)</span>
				}
			})
		});
&nbsp;
		const dimensionHierarchiesLength = this.dimensionHierarchies.length;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(fixSpace).length &gt; dimensionHierarchiesLength) {
<span class="cstat-no" title="statement not covered" >			throw Error(`Set must have a size not more than ${dimensionHierarchiesLength} dimensions`)</span>
		}
&nbsp;
...
&nbsp;
			<span class="missing-if-branch" title="else path not taken" >E</span>if (dimensionTreeProjection){
...
&nbsp;
	...
	drillUp(hierarchy, targetDimension) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (currentHierarchy &amp;&amp; currentHierarchy.hasDimension(targetDimension)) {
	 ...
	 * */
	addFacts(facts) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!Array.isArray(facts)){
<span class="cstat-no" title="statement not covered" >			throw TypeError('The argument must be instance of Array')</span>
		}
...
<span class="cstat-no" title="statement not covered" >			throw TypeError('The argument must be instance of Array')</span>
	 ...
	 * */
	removeCells(cells) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!Array.isArray(cells)){
<span class="cstat-no" title="statement not covered" >			throw TypeError('The argument must be instance of Array')</span>
		}
		cells.forEach((cell) =&gt; {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (!(cell instanceof Cell)){
<span class="cstat-no" title="statement not covered" >				throw TypeError('The list of cells must contain only instances of Cell and EmptyCell')</span>
			}
		});
	...
	getDimensionMembers(dimension) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!(typeof dimension === 'string')){
<span class="cstat-no" title="statement not covered" >			throw TypeError('The first argument must be instance of string')</span>
		}
...
<span class="cstat-no" title="statement not covered" >			throw TypeError('The arguments after the first must be plain objects')</span>
		}
...
<span class="cstat-no" title="statement not covered" >			throw TypeError('The first argument must be instance of string')</span>
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!(member instanceof Member)){
<span class="cstat-no" title="statement not covered" >			throw TypeError('The second argument must be instance of Member')</span>
		}
		const dimensionTree = findDimensionTreeByDimension.call(this, dimension);
...
&nbsp;
	...
	removeDimensionHierarchy(dimensionHierarchy) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!(dimensionHierarchy instanceof DimensionTree)){
<span class="cstat-no" title="statement not covered" >			throw TypeError('The argument must be instance of DimensionTree')</span>
		}
	...
	fillEmptyCells(cellOptions) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (!residuals(this).length) {
	 ...
	 * @return {boolean}
	 * */
<span class="fstat-no" title="function not covered" >	is</span>SubCube(){
<span class="cstat-no" title="statement not covered" >		return this instanceof SubCube;</span>
	}
	/**
	...
	static cartesian(cube) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!(cube instanceof Cube)){
<span class="cstat-no" title="statement not covered" >			throw TypeError('The argument must be instance of Cube')</span>
		}
		...
		let res;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (set.length) {
			if (set.length &gt; 1) {
 ...
 * Get facts from cube
 * */
function denormalize(cells = <span class="branch-0 cbranch-no" title="branch not covered" >this.getCells(),</span> forSave = true) {
	const data = SnowflakeBuilder.denormalize(cells, getDimensionTrees.call(this));
	<span class="missing-if-branch" title="else path not taken" >E</span>if (forSave) {
...
function residuals(cube) {
	...
	tuples.forEach(tuple =&gt; {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (partFacts.length &gt; 1) {
<span class="cstat-no" title="statement not covered" >			totalTuples.push(tuple)</span>
		}
	});
	return totalTuples;
}
 ...
 * @@param {Cube} cube
 * */
function <span class="fstat-no" title="function not covered" >unfilled(</span>cube) {
	const tuples = <span class="cstat-no" title="statement not covered" >Cube.cartesian(cube);</span>
	const unfilled = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >	tuples.forEach(<span class="fstat-no" title="function not covered" >tu</span>ple =&gt; {</span>
		const members = <span class="cstat-no" title="statement not covered" >this.dice(tuple).getFacts(tuple);</span>
<span class="cstat-no" title="statement not covered" >		if (members.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >			unfilled.push(tuple)</span>
		}
	});
<span class="cstat-no" title="statement not covered" >	return unfilled;</span>
}
&nbsp;
export default Cube
&nbsp;</pre></td></tr>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Oct 28 2018 13:20:00 GMT+0300 (MSK)
</div>
</div>
